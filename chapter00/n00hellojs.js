...
// console.log(a, b);
// 이상의 코드에서 자바스크립트 / 파이썬에서는 데이터의 종류를 구변하는 데 있어 타 언어만큼 엄격한 기준이 있지 않습니다.
...
// 이상의 코드에서 알 수 있는 점은 조건식에 자주 사용되구요, 비교 연산의 결과값을 선출할 때 많이 사용 됩니다.
...
// null 'object'
// null의 타입은 object로 반환 -> 초기 설계 부실 둔제
...
// 객체를 통해서 지정한 value를 상수에 지정하여 (#1, #2를 이용해서 특정 값만 산출한 후에), 걔네만 콘솔에 출력함.
